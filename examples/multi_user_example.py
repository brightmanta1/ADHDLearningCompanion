...
async def simulate_video_request(service: ServiceManager, user_id: str, video_url: str) -> Dict[str, Any]:
...
async def simulate_text_request(service: ServiceManager, user_id: str, text: str) -> Dict[str, Any]:
